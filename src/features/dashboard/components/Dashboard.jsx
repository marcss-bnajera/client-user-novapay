import {
    ...
    ArrowRight, TrendingUp, Shield, Bell
} from "lucide-react";
...
const mockResumen = {
    ...
    totalTarjetas: 4,
    totalLibretas: 2,
    balanceTotal: 156550.25,
};

const mockCuentas = [
    { id: 1, nombre_cuenta: "Cuenta Principal",  tipo_cuenta: "MONETARIA",   balance: 12850.75 },
    { id: 2, nombre_cuenta: "Cuenta de Ahorros", tipo_cuenta: "AHORRO",      balance: 45200.00 },
];
    ...
    return (
        <div className="max-w-5xl mx-auto py-8 px-4">
                ...
                <div className="flex items-center justify-between relative flex-wrap gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-emerald-500/80 text-[11px]">@{mockUser.username}</p>
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                {[
                    { label: "Cuentas activas",  value: mockResumen.totalCuentas,  icon: Wallet,       color: "#10b981", bg: "rgba(16,185,129,0.1)", border: "rgba(16,185,129,0.2)" },
                    { label: "Tarjetas",          value: mockResumen.totalTarjetas, icon: CreditCard,   color: "#8b5cf6", bg: "rgba(139,92,246,0.1)", border: "rgba(139,92,246,0.2)" },
                    { label: "Libretas",          value: mockResumen.totalLibretas, icon: BookOpen,     color: "#f59e0b", bg: "rgba(245,158,11,0.1)", border: "rgba(245,158,11,0.2)" },
                    { label: "Balance total",     value: formatBalance(mockResumen.balanceTotal), icon: TrendingUp, color: "#38bdf8", bg: "rgba(56,189,248,0.1)", border: "rgba(56,189,248,0.2)" },
                ...
                <div className="rounded-2xl p-5"
                    ...
                    <div className="flex flex-col gap-3">
                        {mockCuentas.map(cuenta => {
                            const config = cuentaConfig[cuenta.tipo_cuenta] || cuentaConfig.MONETARIA;
                            return (
                                <div key={cuenta.id} className="flex items-center justify-between px-4 py-3 rounded-xl"
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-slate-200 text-[13px] font-medium">{cuenta.nombre_cuenta}</p>
                                            <p className="text-slate-600 text-[10px]">{cuenta.tipo_cuenta}</p>
                                        </div>
                                    </div>
