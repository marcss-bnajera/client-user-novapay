...
import { X, Star, User, Hash, Check } from "lucide-react";
...
export const FavoriteModal = ({ isOpen, onClose, favorite, onSave }) => {
    ...
    const handleSubmit = () => {
        ...
        if (!isEditing && !formData.numero_cuenta_favorito.trim()) return;
        onSave(formData);
    };
            ...
            <div className="w-full max-w-md rounded-2xl overflow-hidden"
                ...
                <div className="px-6 py-4 flex justify-end gap-3"
                    ...
                    <button onClick={handleSubmit}
                        className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-[13px] font-bold text-[#030712] transition-all active:scale-[0.98]"
